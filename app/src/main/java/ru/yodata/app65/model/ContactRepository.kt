...
object ContactRepository {
    ...
    fun getContactList(contResolver: ContentResolver): Single<List<BriefContact>> =
        Single.fromCallable {
    ...
    fun getContactById(contResolver: ContentResolver, contactId: String): Single<Contact> =
        Single.fromCallable {
