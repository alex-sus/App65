...
object PermissionsAccessHelper {
    ...
    fun isPermissionsAvailable(context: Context, permissions: Array<String>): Boolean {
        ...
        override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
            return requireActivity().let {
                ...
                builder.setTitle(getString(R.string.permissions_request_epilogue_title))
                        ...
                        .setPositiveButton(R.string.permissions_request_epilogue_ok_btn) { _, _ ->
                        ...
                        .setNegativeButton(R.string.permissions_request_epilogue_cancel_btn) { _, _ ->
